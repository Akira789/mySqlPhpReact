/*
  ...
  ==========================  ======================  =============
  Se añadio en login las validaciones del usuario y contraseña y el switch de off a on
  Fecha terminada el 24/03/2020
  */
    ...
    render(){
        ...
        <Container>
            <Content padder contentContainerStyle = {misEstilos.content}>
                ...
                <Button primary style = { misEstilos.boton} onPress={() => {this.login() }} >
                    <Text> Entrar </Text>
                    </Button>
                </CardItem>
